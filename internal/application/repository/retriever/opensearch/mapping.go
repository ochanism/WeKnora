...
// — used by the no-embedding save path (Phase 2's
// concurrentBatchSaveNoEmbedding).
...
// would be ideal but expensive; for PR 2 we check the parts that
// matter for query correctness.
