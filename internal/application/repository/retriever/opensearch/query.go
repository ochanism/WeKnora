...
// fan-out (multi-KB) input from the Phase 2 storeGroup as terms.
// ExcludeKnowledgeIDs is included so the OpenSearch driver matches
// Qdrant / pgvector behavior — earlier draft silently dropped it.
